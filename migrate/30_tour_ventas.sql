...
SELECT CURDATE(), NULL, 6000.00, 'REMITO', 'efectivo', 'completado', 'TOUR_DEMO_1'
...
INSERT INTO ventas (fecha, cliente_id, total, tipo_comprobante, tipo_pago, estado, numero_afip)
SELECT CURDATE() - INTERVAL 1 DAY, NULL, 5500.00, 'REMITO', 'transferencia', 'completado', 'TOUR_DEMO_2'
WHERE @v1 > 0;
