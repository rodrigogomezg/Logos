...
function writePHPIni(phpDir) {
  const ini = [
    ...
    '',
    '; Execution limits',
    '; upload_max_filesize/post_max_size en 200M para poder subir un backup .sql',
    '; grande al restaurar (Configuracion::restaurarDesde) — app de escritorio de',
    '; un solo admin, no expuesta a internet, así que un límite alto acá no es',
    '; un riesgo de abuso como lo sería en un server público.',
