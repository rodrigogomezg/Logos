...
<nav class="app-nav">
  ...
  <a href="/Logos/pos/configuracion.html" id="nav-config-link" class="nav-link nav-icon-link nav-config<?= nav_clase('configuracion', $nav_activo) ?>" title="Configuración">
...
<style>
.nav-icon-link { display:inline-flex; align-items:center; gap:4px; }
.nav-icon-label { font-size:11px; font-weight:500; }
</style>
