...
CREATE TABLE `compra_items` (
  ...
  `descuento_monto` decimal(14,4) NOT NULL DEFAULT 0.0000,
...
CREATE TABLE `compras` (
  ...
  `descuento_general_porcentaje` decimal(5,2) DEFAULT NULL,
  `descuento_general_monto` decimal(14,4) NOT NULL DEFAULT 0.0000,
  `actualiza_stock` tinyint(1) NOT NULL DEFAULT 1,
  `actualiza_costos` tinyint(1) NOT NULL DEFAULT 1,
